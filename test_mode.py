...
def train(args):
    ...
    while pre_epoch < args.pre_train_epoch:
        for i, tr_data in enumerate(tqdm(loader, desc=f'Pretrain Epoch {pre_epoch+1}/{args.pre_train_epoch}')):
        ...
        if pre_epoch % 1 == 0:
            torch.save(generator.state_dict(), 'C:/Users/User/Desktop/SRGAN - Copy/div2k_train_val/outputs/adverserial/outputs/pre_trained_model_%03d.pt' % pre_epoch)
    ...
    while fine_epoch < args.fine_train_epoch:
        ...
        for i, tr_data in enumerate(tqdm(loader, desc=f'Adversarial Epoch {fine_epoch+1}/{args.fine_train_epoch}')):
            gt = tr_data['GT'].to(device)
            lr = tr_data['LR'].to(device)
        ...
        if fine_epoch % 1 == 0:
            torch.save(generator.state_dict(), 'C:/Users/User/Desktop/SRGAN - Copy/div2k_train_val/outputs/adverserial/outputs/SRGAN_gene_%03d.pt' % fine_epoch)
            torch.save(discriminator.state_dict(), 'C:/Users/User/Desktop/SRGAN - Copy/div2k_train_val/outputs/adverserial/outputs/SRGAN_discrim_%03d.pt' % fine_epoch)
